...
- Per-user notification center with unread state, ownership checks, report-ready events, and deduplicated low-stock alerts generated by the worker
...
Additional report types, notification delivery preferences, email delivery, and broader end-to-end browser coverage.
